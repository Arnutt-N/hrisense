  ...
  public: {
    Tables: {
      ...
      personnel_risk_scores: {
        Row: { id: string; personnel_id: string; retirement_risk: number; transfer_risk: number; talent_loss_risk: number; vacancy_risk: number; succession_risk: number; overall_score: number; risk_level: string; computed_at: string }
      }
    ...
    Views: {
      v_personnel_overview: { Row: { id: string; citizen_id: string; employee_number: string | null; prefix_th: string | null; first_name_th: string; last_name_th: string; full_name_th: string; retirement_date: string | null; retirement_years_remaining: number | null; organization_id: string; organization_name: string; position_name: string | null; position_type: string | null; position_level: string | null; salary: number | null; status: string; overall_risk_score: number | null; risk_level: string | null } }
